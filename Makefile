...
ROMFS		:=	romfs
APP_AUTHOR	:=	Robz8
APP_DESCRIPTION :=  480i Image Gallery for 3DS
ICON		:=	app/icon.png
...
$(OUTPUT).cia	:	$(OUTPUT).elf $(OUTPUT).smdh
	...
	../tools/makerom -f cia -target t -exefslogo -o "../480i-test.cia" -elf "../480i-test.elf" -rsf "../app/build-cia.rsf" -banner "../app/banner.bin" -icon "../app/icon.bin" -DAPP_ROMFS="$(TOPDIR)/$(ROMFS)" -major $(VERSION_MAJOR) -minor $(VERSION_MINOR) -micro $(VERSION_MICRO) -DAPP_VERSION_MAJOR="$(VERSION_MAJOR)"
